  ...
  return (
    <div
      ...
      style={{
        ...
        position: "relative",
        overflow: "hidden",
        maskImage: "linear-gradient(to bottom, transparent 0%, black 15%, 85%, 100%)",
        WebkitMaskImage: "linear-gradient(to bottom, transparent 0%, black 15%, 85%, 100%)",
      }}
    >
      <div
        style={{
          ...
          bottom: 0,
          background:
            "linear-gradient(to bottom, rgba(255,255,255,0.1) 0%, transparent 20%, 80%, 100%)",
          pointerEvents: "none",
          zIndex: 10,
        }}
      />
