  ...
  return (
    ...
    >
      ...
      <div className="relative mb-8">
        <div className="w-32 h-32 bg-gradient-to-br from-indigo-500 to-purple-500 rounded-3xl opacity-10 absolute inset-0 blur-2xl" />
        <div className="relative w-32 h-32 bg-gradient-to-br from-indigo-100 to-purple-100 rounded-3xl flex items-center justify-center">
          <FileCode className="h-16 w-16 text-indigo-600" />
        </div>
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-4 mb-12">
        <button
          ...
          className="flex items-center gap-3 px-6 py-3 bg-indigo-600 text-white rounded-xl font-medium hover:bg-indigo-700 transition-colors shadow-lg shadow-indigo-500/30"
        >
